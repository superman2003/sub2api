...
const BADGE: Record<Platform, string> = {
  ...
  kiro: 'bg-indigo-500/10 text-indigo-600 border-indigo-500/30 dark:text-indigo-400',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  kiro: 'bg-indigo-500/10 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-300',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  kiro: 'bg-gradient-to-r from-indigo-400 to-indigo-500',
}
...
const ICON: Record<Platform, string> = {
  ...
  kiro: 'text-indigo-500 dark:text-indigo-400',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  kiro: 'bg-indigo-500 text-white hover:bg-indigo-600 active:bg-indigo-700 dark:bg-indigo-500/80 dark:hover:bg-indigo-500',
}
