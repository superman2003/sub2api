...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	kiroGatewayService := service.NewKiroGatewayService(kiroTokenProvider, settingService)
	...
	kiroQuotaFetcher := service.NewKiroQuotaFetcher(proxyRepository, kiroTokenProvider)
	kiroOAuthHandler := admin.NewKiroOAuthHandler(kiroOAuthService, adminService, kiroQuotaFetcher)
